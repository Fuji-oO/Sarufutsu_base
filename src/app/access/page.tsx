      ...
      <div className="min-h-screen py-16 md:py-[120px] px-2 md:px-4" style={{ background: '#F5EEDC' }}>
        ...
        <div className="max-w-4xl mx-auto pt-10 md:pt-50 text-center text-xs md:text-base leading-relaxed bg-[#FEFDFC]" style={{border: '2px solid #bfae8a', borderRadius: '16px', marginTop: '24px', padding: '20px 8px', boxSizing: 'border-box'}}>
          <span className="block md:hidden">
            ...
            <p className="mt-4">
              稚内駅からお越しの際は、<br />バスまたはレンタカーのご利用をおすすめいたします。<br />
              その他のアクセス方法については、お気軽にお問い合わせください。
            </p>
            <p className="mt-4">
              なお、冬期は積雪や路面の凍結がございますので、<br />冬用装備を万全にしてお越しください。
            </p>
          </span>
          <span className="hidden md:block">
            <p>
              現地へお越しの際は、基本的にお車またはバイク等にてお越しいただくようご案内しております。<br /><br />
              稚内駅からお越しの際は、バスまたはレンタカーのご利用をおすすめいたします。<br />
              その他のアクセス方法については、お気軽にお問い合わせください。<br /><br />
              なお、冬期は積雪や路面の凍結がございますので、冬用装備を万全にしてお越しください。
            </p>
          </span>
        </div>
      </div>
