...
const FAQ_LIST = {
  ...
  facility: [
    ...
    },
    {
      ...
      a: "共有スペースは、リビング・キッチン・トイレ・バス・洗面台がございます。",
    },
    {
      q: "洗濯機や乾燥機は使えますか？",
    ...
    {
      q: "冷暖房設備は各客室にありますか？",
      a: "各客室に冷房設備はございませんが、暖房設備はございます。なお、フリースペースには冷暖房設備がございます。",
    },
    {
      q: "Wi-Fiは利用できますか？",
  ...
  service: [
    {
      ...
      a: "お部屋の清掃やシーツ交換は、4泊以上のご滞在の場合に限り、3日ごとに行います。それ以外の日程で清掃をご希望の際は有償となります。ご希望の際は、お気軽にお声掛けください。",
    },
    {
