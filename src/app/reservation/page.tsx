        ...
        <div className="max-w-3xl mx-auto bg-white bg-opacity-90 rounded-lg shadow-lg px-4 py-8 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
            ...
            <div className="mt-8 flex flex-col items-center justify-center">
              <p className="text-xs md:text-base text-gray-700 mb-3 text-center" style={{fontFamily: 'Klee One, cursive'}}>
                最新の空室状況は
                <span className="inline-block md:block">Instagramをご確認いただくか、お問い合わせください。</span>
              </p>
              <a
                href="https://www.instagram.com/sarufutsu_base/"
                target="_blank"
                rel="noopener noreferrer"
                className="font-semibold text-[#333] hover:text-[#111] text-base md:text-lg flex items-center gap-2 view-more-link border border-[#BFAE8A] rounded-full px-4 py-2 transition-colors duration-200"
