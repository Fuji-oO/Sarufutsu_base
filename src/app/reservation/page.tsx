        ...
        <div className="max-w-3xl mx-auto bg-white bg-opacity-90 rounded-lg shadow-lg px-4 py-8 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col items-center justify-center">
              <p className="text-xs md:text-lg text-gray-700 mb-3 text-center" style={{fontFamily: 'Klee One, cursive'}}>
              ...
              <a
                ...
                className="font-semibold text-[#333] hover:text-[#111] text-xs md:text-lg flex items-center gap-2 view-more-link border border-[#BFAE8A] rounded-full px-4 py-2 transition-colors duration-200 hover:bg-[#BFAE8A]"
