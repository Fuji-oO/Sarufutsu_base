...
export default function Room1TypePage() {
  const images = [
    { src: '/images/S__36700182_0.jpg', alt: 'Room1 Main' },
    ...
    <FadeTransitionWrapper>
      <div className="min-h-screen pt-16 pb-24 md:py-[120px]" style={{background:'#F5EEDC'}}>
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="text-ml md:text-2xl font-bold mb-4 md:mb-8 text-center">Room01</div>
          {/* メイン画像 */}
          ...
          <div className="block md:hidden text-xs text-gray-700 mb-4 md:mb-6">
            オレンジのアクセントクロスが明るく、<br />
            温かみのある印象の個室タイプのお部屋です。<br />
            1名様からご利用いただけます。<br />
            ご就寝の際は、寝具一式（敷き布団・掛け布団・枕）を<br />ご利用いただきます。<br /><br />
          ...
          <div className="hidden md:block text-sm text-gray-700 mb-4 md:mb-6">
            ...
            1名様からご利用いただけます。<br />
            ご就寝の際は、寝具一式（敷き布団・掛け布団・枕）をご利用いただきます。<br /><br />  
          ...
          <div className="text-xs md:text-sm text-gray-700 mb-2 md:mb-4">テーブル／Wi-Fi／コンセント(8口)</div>
          <div className="border-t border-gray-200 my-2 md:my-4" style={{borderColor:'#D9CBB0'}}/>
